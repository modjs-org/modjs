...
export default function Page() {
    ...
    const sections = [
        'slideshow-footer-api',
        'import',
        'slideshow-footer-props',
        'system-props',
                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_slideshow_footer"
                                    >
                                        react-slideshow-footer
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="slideshow-footer-api">
                                <Typography variant="h1">
                                    React SlideshowFooter API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React SlideshowFooter
                                    component from Modj.js. Learn about how to
                                    use the SlideshowFooter component and all
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SlideshowFooter"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SlideshowFooter } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="slideshow-footer-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    SlideshowFooter component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_slideshow_excerpt_api"
                                >
                                    <LeftArrowIcon />
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_slideshow_item_api"
                                >
                                    SlideshowItem API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#slideshow-footer-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
