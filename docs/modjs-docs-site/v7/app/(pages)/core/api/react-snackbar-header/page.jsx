                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_snackbar_header"
                                    >
                                        react-snackbar-header
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="snackbar-header-api">
                                <Typography variant="h1">
                                    React SnackbarHeader API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React SnackbarHeader
                                    component from Modj.js. Learn about how to
                                    use the SnackbarHeader component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SnackbarHeader"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SnackbarHeader } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="snackbar-header-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    SnackbarHeader component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_snackbar_content_api"
                                >
                                    <LeftArrowIcon />
                                    SnackbarContent API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#snackbar-header-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
