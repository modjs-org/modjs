                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_card_media"
                                    >
                                        react-card-media
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="card-media-api">
                                <Typography variant="h1">
                                    React CardMedia API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CardMedia
                                    component from Modj.js. Learn about how to
                                    use the CardMedia component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CardMedia"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CardMedia } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="card-media-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    CardMedia Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    CardMedia component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_card_header_api"
                                >
                                    <LeftArrowIcon />
                                    CardHeader API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_card_meta_api"
                                >
                                    CardMeta API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#card-media-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
