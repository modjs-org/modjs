        ...
        <>
            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#dropdown-content-api"
                        active={/#dropdown-content-api$/.test(fragmentId)}
                        data-testid="dropdown_content_api"
                    >
                        DropdownContent API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#dropdown-content-props"
                        active={/#dropdown-content-props$/.test(fragmentId)}
                        data-testid="dropdown_content_props"
                    >
