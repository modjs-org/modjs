                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_copy"
                                    >
                                        react-copy
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="copy-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Copy component
                                    from Modj.js. Learn about how to use the
                                    Copy component and all the valid props that
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Copy"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Copy } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="copy-props" pb="normal" mt={16}>
                                <Typography variant="h2">Copy Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Copy
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_container_api"
                                >
                                    <LeftArrowIcon />
                                    Container API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_copy_response_api"
                                >
                                    CopyResponse API
                                    <RightArrowIcon />
                                </Link>
