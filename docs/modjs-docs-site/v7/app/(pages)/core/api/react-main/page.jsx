                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_main"
                                    >
                                        react-main
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="main-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Main component
                                    from Modj.js. Learn about how to use the
                                    Main component and all the valid props that
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Main"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Main } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="main-props" pb="normal" mt={16}>
                                <Typography variant="h2">Main Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Main
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_message_area_api"
                                >
                                    MessageArea API
                                    <RightArrowIcon />
                                </Link>
