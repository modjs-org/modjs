            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#table-data-api"
                        active={/#table-data-api$/.test(fragmentId)}
                        data-testid="table_data_api"
                    >
                        TableData API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#table-data-props"
                        active={/#table-data-props$/.test(fragmentId)}
                        data-testid="table_data_props"
                    >
                        TableData Props
                    </Link>
                </List>
