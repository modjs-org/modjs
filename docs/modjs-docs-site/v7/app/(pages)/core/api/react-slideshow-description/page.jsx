...
export default function Page() {
    ...
    const sections = [
        'slideshow-description-api',
        'import',
        'slideshow-description-props',
        'system-props',
                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_slideshow_description"
                                    >
                                        react-slideshow-description
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="slideshow-description-api">
                                <Typography variant="h1">
                                    React SlideshowDescription API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React
                                    SlideshowDescription component from Modj.js.
                                    Learn about how to use the
                                    SlideshowDescription component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SlideshowDescription"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SlideshowDescription } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="slideshow-description-props"
                                pb="normal"
                                mt={16}
                            >
                                <Typography variant="h2">
                                    SlideshowDescription Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    SlideshowDescription component and can be
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_slideshow_api"
                                >
                                    <LeftArrowIcon />
                                    Slideshow API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_slideshow_excerpt_api"
                                >
                                    SlideshowExcerpt API
                                    <RightArrowIcon />
                                </Link>
                            </Box>
                        </Container>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#slideshow-description-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
