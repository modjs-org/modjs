        ...
        <>
            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#slideshow-description-api"
                        active={/#slideshow-description-api$/.test(fragmentId)}
                        data-testid="slideshow_description_api"
                    >
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#slideshow-description-props"
                        active={/#slideshow-description-props$/.test(
                            fragmentId,
                        )}
                        data-testid="slideshow_description_props"
                    >
