                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_breadcrumbs"
                                    >
                                        react-breadcrumbs
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="breadcrumbs-api">
                                <Typography variant="h1">
                                    React Breadcrumbs API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Breadcrumbs
                                    component from Modj.js. Learn about how to
                                    use the Breadcrumbs component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Breadcrumbs"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Breadcrumbs } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="breadcrumbs-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Breadcrumbs Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Breadcrumbs component and can be applied to
                                    this component.
                                </Typography>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#breadcrumbs-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
