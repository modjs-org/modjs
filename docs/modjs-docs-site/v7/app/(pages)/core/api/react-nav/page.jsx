                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_nav"
                                    >
                                        react-nav
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="nav-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Nav component
                                    from Modj.js. Learn about how to use the Nav
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Nav"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Nav } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="nav-props" pb="normal" mt={16}>
                                <Typography variant="h2">Nav Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Nav
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_name_field_api"
                                >
                                    <LeftArrowIcon />
                                    NameField API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_ordered_list_api"
                                >
                                    OrderedList API
                                    <RightArrowIcon />
                                </Link>
