                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_carousel_item"
                                    >
                                        react-carousel-item
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CarouselItem"
                                                        target="_blank"
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_carousel_footer_api"
                                >
                                    <LeftArrowIcon />
                                    CarouselFooter API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_carousel_media_api"
                                >
                                    CarouselMedia API
                                    <RightArrowIcon />
                                </Link>
