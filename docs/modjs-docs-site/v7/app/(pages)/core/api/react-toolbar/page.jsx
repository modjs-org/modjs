                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_toolbar"
                                    >
                                        react-toolbar
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="toolbar-api">
                                <Typography variant="h1">
                                    React Toolbar API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Toolbar
                                    component from Modj.js. Learn about how to
                                    use the Toolbar component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Toolbar"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Toolbar } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="toolbar-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Toolbar Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Toolbar component and can be applied to this
                                    component.
                                </Typography>
                            ...
                            >
                                <Link
                                    href="/core/api/react-appbar-textarea"
                                    variant="inline"
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_textarea_api"
                                >
                                    <LeftArrowIcon />
                                    TextArea API
                                </Link>
