                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_list"
                                    >
                                        react-list
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="list-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React List component
                                    from Modj.js. Learn about how to use the
                                    List component and all the valid props that
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/List"
                                                        target="_blank"
                                ...
                                >
                                    {`import { List } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="list-props" pb="normal" mt={16}>
                                <Typography variant="h2">List Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the List
