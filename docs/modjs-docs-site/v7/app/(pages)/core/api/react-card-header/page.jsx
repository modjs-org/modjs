                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_card_header"
                                    >
                                        react-card-header
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="card-header-api">
                                <Typography variant="h1">
                                    React CardHeader API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CardHeader
                                    component from Modj.js. Learn about how to
                                    use the CardHeader component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CardHeader"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CardHeader } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="card-header-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    CardHeader Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    CardHeader component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_card_footer_api"
                                >
                                    <LeftArrowIcon />
                                    CardFooter API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_card_media_api"
                                >
                                    CardMedia API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#card-header-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
