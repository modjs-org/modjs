                ...
                <Box display="flex">
                    ...
                    >
                        ...
                        <Container fluid={false}>
                            <Section id="header-api">
                                <Typography variant="h1">
                                    React Header API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Header component
                                    from Modj.js. Learn about how to use the
                                    Header component and all the valid props
                            ...
                            <Section id="import">
                                ...
                                >
                                    {`import { Header } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="header-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Header Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Header component and can be applied to this
                                    component.
                                </Typography>
