            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#table-head-api"
                        active={/#table-head-api$/.test(fragmentId)}
                        data-testid="table_head_api"
                    >
                        TableHead API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#table-head-props"
                        active={/#table-head-props$/.test(fragmentId)}
                        data-testid="table_head_props"
                    >
                        TableHead Props
                    </Link>
                </List>
