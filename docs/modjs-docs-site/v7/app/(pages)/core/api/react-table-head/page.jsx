                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_table_head"
                                    >
                                        react-table-head
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="table-head-api">
                                <Typography variant="h1">
                                    React TableHead API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React TableHead
                                    component from Modj.js. Learn about how to
                                    use the TableHead component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/TableHead"
                                                        target="_blank"
                                ...
                                >
                                    {`import { TableHead } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="table-head-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    TableHead Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    TableHead component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_table_data_api"
                                >
                                    <LeftArrowIcon />
                                    TableData API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_table_header_api"
                                >
                                    TableHeader API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#table-head-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
