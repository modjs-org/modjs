                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_footer"
                                    >
                                        react-footer
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="footer-api">
                                <Typography variant="h1">
                                    React Footer API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Footer component
                                    from Modj.js. Learn about how to use the
                                    Footer component and all the valid props
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Footer"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Footer } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="footer-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Footer Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Footer component and can be applied to this
                                    component.
                                </Typography>
