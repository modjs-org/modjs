                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_avatar"
                                    >
                                        react-avatar
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="avatar-api">
                                <Typography variant="h1">
                                    React Avatar API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Avatar component
                                    from Modj.js. Learn about how to use the
                                    Avatar component and all the valid props
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Avatar"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Avatar } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="avatar-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Avatar Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Avatar component and can be applied to this
                                    component.
                                </Typography>
