                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_slideshow"
                                    >
                                        react-slideshow
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="slideshow-api">
                                <Typography variant="h1">
                                    React Slideshow API (Experimental)
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Slideshow
                                    component from Modj.js. Learn about how to
                                    use the Slideshow component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Slideshow"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Slideshow } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="slideshow-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Slideshow Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Slideshow component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_side_navigation_api"
                                >
                                    <LeftArrowIcon />
                                    SideNavigation API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_slideshow_description_api"
                                >
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#slideshow-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
