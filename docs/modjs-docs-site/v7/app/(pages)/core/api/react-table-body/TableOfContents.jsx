            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#table-body-api"
                        active={/#table-body-api$/.test(fragmentId)}
                        data-testid="table_body_api"
                    >
                        TableBody API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#table-body-props"
                        active={/#table-body-props$/.test(fragmentId)}
                        data-testid="table_body_props"
                    >
                        TableBody Props
                    </Link>
                </List>
