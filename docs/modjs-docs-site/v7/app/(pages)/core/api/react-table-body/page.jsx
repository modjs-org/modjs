                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_table_body"
                                    >
                                        react-table-body
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="table-body-api">
                                <Typography variant="h1">
                                    React TableBody API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React TableBody
                                    component from Modj.js. Learn about how to
                                    use the TableBody component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/TableBody"
                                                        target="_blank"
                                ...
                                >
                                    {`import { TableBody } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="table-body-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    TableBody Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    TableBody component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_table_data_api"
                                >
                                    TableData API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#table-body-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
