                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_text_fields"
                                    >
                                        react-text-field
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="text-field-api">
                                <Typography variant="h1">
                                    React TextField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React TextField
                                    component from Modj.js. Learn about how to
                                    use the TextField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/TextField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { TextField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="text-field-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    TextField Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    TextField component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_table_row_api"
                                >
                                    <LeftArrowIcon />
                                    TableRow API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#text-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
