                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_snackbar_content"
                                    >
                                        react-snackbar-content
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="snackbar-content-api">
                                <Typography variant="h1">
                                    React SnackbarContent API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React SnackbarContent
                                    component from Modj.js. Learn about how to
                                    use the SnackbarContent component and all
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SnackbarContent"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SnackbarContent } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="snackbar-content-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    SnackbarContent component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_snackbar_header_api"
                                >
                                    SnackbarHeader API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#snackbar-content-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
