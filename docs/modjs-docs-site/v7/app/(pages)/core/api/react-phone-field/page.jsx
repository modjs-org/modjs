                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_phone_field"
                                    >
                                        react-phone-field
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="phone-field-api">
                                <Typography variant="h1">
                                    React PhoneField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React PhoneField
                                    component from Modj.js. Learn about how to
                                    use the PhoneField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/PhoneField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { PhoneField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="phone-field-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    PhoneField Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    PhoneField component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_password_field_api"
                                >
                                    <LeftArrowIcon />
                                    PasswordField API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#phone-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
