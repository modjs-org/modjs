                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_section"
                                    >
                                        react-section
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="section-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Section
                                    component from Modj.js. Learn about how to
                                    use the Section component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Section"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Section } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="section-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Section Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Section component and can be applied to this
                                    component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_search_results_api"
                                >
                                    <LeftArrowIcon />
                                    SearchResults API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_separator_api"
                                >
                                    Separator API
                                    <RightArrowIcon />
                                </Link>
