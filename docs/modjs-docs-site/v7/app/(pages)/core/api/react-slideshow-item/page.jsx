                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_slideshow_item"
                                    >
                                        react-slideshow-item
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="slideshow-item-api">
                                <Typography variant="h1">
                                    React SlideshowItem API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React SlideshowItem
                                    component from Modj.js. Learn about how to
                                    use the SlideshowItem component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SlideshowItem"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SlideshowItem } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="slideshow-item-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    SlideshowItem component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_slideshow_footer_api"
                                >
                                    <LeftArrowIcon />
                                    SlideshowFooter API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_slideshow_media_api"
                                >
                                    SlideshowMedia API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#slideshow-item-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
