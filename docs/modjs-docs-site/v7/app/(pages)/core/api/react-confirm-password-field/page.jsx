...
export default function Page() {
    ...
    const sections = [
        'confirm-password-field-api',
        'import',
        'confirm-password-field-props',
        'system-props',
                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_confirm_password_field"
                                    >
                                        react-confirm-password-field
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="confirm-password-field-api">
                                <Typography variant="h1">
                                    React ConfirmPasswordField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React
                                    ConfirmPasswordField component from Modj.js.
                                    Learn about how to use the
                                    ConfirmPasswordField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/ConfirmPasswordField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { ConfirmPasswordField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="confirm-password-field-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    ConfirmPasswordField component and can be
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            <TableData>compareWith</TableData>
                                            <TableData>
                                                <Pill color="success">
                                                    string
                                                </Pill>
                                            ...
                                            <TableData>-</TableData>
                                            <TableData>
                                                Campare value of this component
                                                with the value of
                                                CreatePasswordField component.
                                            </TableData>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_code_editor_api"
                                >
                                    <LeftArrowIcon />
                                    CodeEditor API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_container_api"
                                >
                                    Container API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#confirm-password-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
