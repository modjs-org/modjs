                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_appbar"
                                    >
                                        react-appbar
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="appbar-api">
                                <Typography variant="h1">
                                    React Appbar API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Appbar component
                                    from Modj.js. Learn about how to use the
                                    Appbar component and all the valid props
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Appbar"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Appbar } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="appbar-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Appbar Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Appbar component and can be applied to this
                                    component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_accordion_title_api"
                                >
                                    <LeftArrowIcon />
                                    AccordionTitle API
                                </Link>
