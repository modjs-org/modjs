                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_content"
                                    >
                                        react-card-content
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="card-content-api">
                                <Typography variant="h1">
                                    React CardContent API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CardContent
                                    component from Modj.js. Learn about how to
                                    use the CardContent component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CardContent"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CardContent } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>
                            ...
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    CardContent component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_card_footer_api"
                                >
                                    CardFooter API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#card-content-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
