                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_tooltip"
                                    >
                                        react-tooltip
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="tooltip-api">
                                <Typography variant="h1">
                                    React Tooltip API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Tooltip
                                    component from Modj.js. Learn about how to
                                    use the Tooltip component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Tooltip"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Tooltip } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="tooltip-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Tooltip Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Tooltip component and can be applied to this
                                    component.
                                </Typography>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableData>-</TableData>
                                            <TableData>
                                                The node to apply the tooltip
                                                to.
                                            </TableData>
                                        </TableRow>
                                        <TableRow>
                                            <TableData>arrow</TableData>
                                            <TableData>
                                                <Pill color="success">
                                                    boolean
                                                </Pill>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_tooltip_content_api"
                                >
                                    TooltipContent API
                                    <RightArrowIcon />
                                </Link>
