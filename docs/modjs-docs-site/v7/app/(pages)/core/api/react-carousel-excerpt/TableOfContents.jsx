        ...
        <>
            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#carousel-excerpt-api"
                        active={/#carousel-excerpt-api$/.test(fragmentId)}
                        data-testid="carousel_excerpt_api"
                    >
                        CarouselExcerpt API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#carousel-excerpt-props"
                        active={/#carousel-excerpt-props$/.test(fragmentId)}
                        data-testid="carousel_excerpt_props"
                    >
