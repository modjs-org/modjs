...
export default function Page() {
    ...
    const sections = [
        'carousel-excerpt-api',
        'import',
        'carousel-excerpt-props',
        'system-props',
                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_carousel_excerpt"
                                    >
                                        react-carousel-excerpt
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="carousel-excerpt-api">
                                <Typography variant="h1">
                                    React CarouselExcerpt API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CarouselExcerpt
                                    component from Modj.js. Learn about how to
                                    use the CarouselExcerpt component and all
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CarouselExcerpt"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CarouselExcerpt } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="carousel-excerpt-props"
                                pb="normal"
                                mt={16}
                            >
                                <Typography variant="h2">
                                    CarouselExcerpt Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    CarouselExcerpt component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_carousel_description_api"
                                >
                                    <LeftArrowIcon />
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_carousel_footer_api"
                                >
                                    CarouselFooter API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#carousel-excerpt-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
