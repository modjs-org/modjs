                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_textarea"
                                    >
                                        react-textarea
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="textarea-api">
                                <Typography variant="h1">
                                    React Textarea API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Textarea
                                    component from Modj.js. Learn about how to
                                    use the Textarea component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/TextArea"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Textarea } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="textarea-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Textarea Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Textarea component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    href="/core/api/react-appbar-text-field"
                                    variant="inline"
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_text_field_api"
                                >
                                    <LeftArrowIcon />
                                    TextField API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#textarea-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
