                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_fieldset"
                                    >
                                        react-fieldset
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="fieldset-api">
                                <Typography variant="h1">
                                    React Fieldset API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Fieldset
                                    component from Modj.js. Learn about how to
                                    use the Fieldset component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Fieldset"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Fieldset } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="fieldset-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Fieldset Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Fieldset component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_email_field_api"
                                >
                                    <LeftArrowIcon />
                                    EmailField API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#fieldset-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
