                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_card"
                                    >
                                        react-card
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="card-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Card component
                                    from Modj.js. Learn about how to use the
                                    Card component and all the valid props that
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Card"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Card } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="card-props" pb="normal" mt={16}>
                                <Typography variant="h2">Card Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Card
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_card_content_api"
                                >
                                    CardContent API
                                    <RightArrowIcon />
                                </Link>
