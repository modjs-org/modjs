                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_table"
                                    >
                                        react-table
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="table-api">
                                <Typography variant="h1">
                                    React Table API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Table component
                                    from Modj.js. Learn about how to use the
                                    Table component and all the valid props that
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Table"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Table } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="table-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Table Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Table component and can be applied to this
                                    component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_snackbar_header_api"
                                >
                                    <LeftArrowIcon />
                                    SnackbarHeader API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_table_body_api"
                                >
                                    TableBody API
                                    <RightArrowIcon />
                                </Link>
