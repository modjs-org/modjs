                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_link"
                                    >
                                        react-link
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="link-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Link component
                                    from Modj.js. Learn about how to use the
                                    Link component and all the valid props that
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Link"
                                                        target="_blank"
                            ...
                            <Section id="link-props" pb="normal" mt={16}>
                                <Typography variant="h2">Link Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Link
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_linear_progress_api"
                                >
                                    <LeftArrowIcon />
                                    LinearProgress API
                                </Link>
