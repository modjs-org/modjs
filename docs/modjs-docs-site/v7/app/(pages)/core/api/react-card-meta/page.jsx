                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_card_meta"
                                    >
                                        react-card-meta
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="card-meta-api">
                                <Typography variant="h1">
                                    React CardMeta API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CardMeta
                                    component from Modj.js. Learn about how to
                                    use the CardMeta component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CardMeta"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CardMeta } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="card-meta-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    CardMeta Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    CardMeta component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_card_media_api"
                                >
                                    <LeftArrowIcon />
                                    CardMedia API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#card-meta-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
