                ...
                <Box display="flex">
                    ...
                    >
                        ...
                        <Container fluid={false}>
                            <Section id="appbar-mobile-api">
                                <Typography variant="h1">
                                    React AppbarMobile API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React AppbarMobile
                                    component from Modj.js. Learn about how to
                                    use the AppbarMobile component and all the
                            ...
                            <Section id="import">
                                ...
                                >
                                    {`import { AppbarMobile } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="appbar-mobile-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    AppbarMobile component and can be applied to
                                    this component.
                                </Typography>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableData>
                                                If true, the mobile appbar will
                                                stick to the top.
                                            </TableData>
                                        </TableRow>
                                    </TableBody>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#appbar-mobile-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
