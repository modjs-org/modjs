                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_table_header"
                                    >
                                        react-table-header
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="table-header-api">
                                <Typography variant="h1">
                                    React TableHeader API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React TableHeader
                                    component from Modj.js. Learn about how to
                                    use the TableHeader component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/TableHeader"
                                                        target="_blank"
                                ...
                                >
                                    {`import { TableHeader } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>
                            ...
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    TableHeader component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_table_head_api"
                                >
                                    <LeftArrowIcon />
                                    TableHead API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_table_row_api"
                                >
                                    TableRow API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#table-header-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
