                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_typography"
                                    >
                                        react-typography
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="typography-api">
                                <Typography variant="h1">
                                    React Typography API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Typography
                                    component from Modj.js. Learn about how to
                                    use the Typography component and all the
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Typography"
                                                        target="_blank"
                            ...
                            <Section id="typography-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Typography Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Typography component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_tooltip_content_api"
                                >
                                    <LeftArrowIcon />
                                    TooltipContent API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_unordered_list_api"
                                >
                                    UnorderedList API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#typography-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
