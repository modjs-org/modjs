            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#typography-api"
                        active={/#typography-api$/.test(fragmentId)}
                        data-testid="typography_api"
                    >
                        Typography API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#typography-props"
                        active={/#typography-props$/.test(fragmentId)}
                        data-testid="typography_props"
                    >
                        Typography Props
                    </Link>
                </List>
