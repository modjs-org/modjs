                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_search_field"
                                    >
                                        react-search-field
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="search-field-api">
                                <Typography variant="h1">
                                    React SearchField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React SearchField
                                    component from Modj.js. Learn about how to
                                    use the SearchField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SearchField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SearchField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="search-field-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    SearchField component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_search_results_api"
                                >
                                    SearchResults API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#search-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
