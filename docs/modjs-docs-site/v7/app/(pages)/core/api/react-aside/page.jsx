                ...
                <Box display="flex">
                    ...
                    >
                        ...
                        <Container fluid={false}>
                            <Section id="aside-api">
                                <Typography variant="h1">
                                    React Aside API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Aside component
                                    from Modj.js. Learn about how to use the
                                    Aside component and all the valid props that
                            ...
                            <Section id="import">
                                ...
                                >
                                    {`import { Aside } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="aside-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Aside Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Aside component and can be applied to this
                                    component.
                                </Typography>
