                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_table_row"
                                    >
                                        react-table-row
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="table-row-api">
                                <Typography variant="h1">
                                    React TableRow API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React TableRow
                                    component from Modj.js. Learn about how to
                                    use the TableRow component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/TableRow"
                                                        target="_blank"
                                ...
                                >
                                    {`import { TableRow } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="table-row-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    TableRow Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    TableRow component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_table_header_api"
                                >
                                    <LeftArrowIcon />
                                    TableHeader API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_text_field_api"
                                >
                                    TextField API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#table-row-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
