                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_name_field"
                                    >
                                        react-name-field
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="name-field-api">
                                <Typography variant="h1">
                                    React NameField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React NameField
                                    component from Modj.js. Learn about how to
                                    use the NameField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/NameField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { NameField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="name-field-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    NameField Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    NameField component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_modal_content_api"
                                >
                                    <LeftArrowIcon />
                                    ModalContent API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#name-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
