                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_container"
                                    >
                                        react-container
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="container-api">
                                <Typography variant="h1">
                                    React Container API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Container
                                    component from Modj.js. Learn about how to
                                    use the Container component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Container"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Container } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="container-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Container Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Container component and can be applied to
                                    this component.
                                </Typography>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableData>
                                                ...
                                                small padding to the right and
                                                left
                                            </TableData>
                                        </TableRow>
                                    </TableBody>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_confirm_password_field_api"
                                >
                                    <LeftArrowIcon />
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#container-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
