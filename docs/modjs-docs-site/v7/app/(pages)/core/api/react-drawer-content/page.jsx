                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_drawer_content"
                                    >
                        ...
                        <Container fluid={false}>
                            <Section id="drawer-content-api">
                                <Typography variant="h1">
                                    React DrawerContent API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React DrawerContent
                                    component from Modj.js. Learn about how to
                                    use the DrawerContent component and all the
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/DrawerContent"
                                                        target="_blank"
                            ...
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    DrawerContent component and can be applied
                                    to this component.
                                </Typography>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#drawer-content-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
