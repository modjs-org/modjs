                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_layout"
                                    >
                                        react-layout
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="layout-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Layout component
                                    from Modj.js. Learn about how to use the
                                    Layout component and all the valid props
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Layout"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Layout } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="layout-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Layout Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Layout component and can be applied to this
                                    component.
                                </Typography>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_linear_progress_api"
                                >
                                    LinearProgress API
                                    <RightArrowIcon />
                                </Link>
