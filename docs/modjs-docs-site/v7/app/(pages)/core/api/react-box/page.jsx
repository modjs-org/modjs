                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_box"
                                    >
                                        react-box
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="box-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Box component
                                    from Modj.js. Learn about how to use the Box
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Box"
                                                        target="_blank"
                            ...
                            <Section id="box-props" pb="normal" mt={16}>
                                <Typography variant="h2">Box Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Box
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_breadcrumbs_api"
                                >
                                    Breadcrumbs API
                                    <RightArrowIcon />
                                </Link>
