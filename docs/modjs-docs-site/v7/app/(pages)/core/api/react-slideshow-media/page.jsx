                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_slideshow_media"
                                    >
                                        react-slideshow-media
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="slideshow-media-api">
                                <Typography variant="h1">
                                    React SlideshowMedia API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React SlideshowMedia
                                    component from Modj.js. Learn about how to
                                    use the SlideshowMedia component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/SlideshowMedia"
                                                        target="_blank"
                                ...
                                >
                                    {`import { SlideshowMedia } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="slideshow-media-props"
                                pb="normal"
                                mt={16}
                            >
                                <Typography variant="h2">
                                    SlideshowMedia Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    SlideshowMedia component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_slideshow_item_api"
                                >
                                    <LeftArrowIcon />
                                    SlideshowItem API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#slideshow-media-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
