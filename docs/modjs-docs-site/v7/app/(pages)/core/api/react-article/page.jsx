                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_article"
                                    >
                                        react-article
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="article-api">
                                <Typography variant="h1">
                                    React Article API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Article
                                    component from Modj.js. Learn about how to
                                    use the Article component and all the valid
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Article"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Article } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="article-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Article Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Article component and can be applied to this
                                    component.
                                </Typography>
