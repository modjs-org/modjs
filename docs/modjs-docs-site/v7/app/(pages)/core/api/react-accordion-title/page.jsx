                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_accordion_title"
                                    >
                                        react-accordion-title
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="accordion-title-api">
                                <Typography variant="h1">
                                    React AccordionTitle API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React AccordionTitle
                                    component from Modj.js. Learn about how to
                                    use the AccordionTitle component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/AccordionTitle"
                                                        target="_blank"
                                ...
                                >
                                    {`import { AccordionTitle } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="accordion-title-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    AccordionTitle component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_accordion_content_api"
                                >
                                    <LeftArrowIcon />
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#accordion-title-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
