                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_carousel_media"
                                    >
                                        react-carousel-media
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="carousel-media-api">
                                <Typography variant="h1">
                                    React CarouselMedia API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CarouselMedia
                                    component from Modj.js. Learn about how to
                                    use the CarouselMedia component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CarouselMedia"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CarouselMedia } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="carousel-media-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    CarouselMedia component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_carousel_item_api"
                                >
                                    <LeftArrowIcon />
                                    CarouselItem API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_code_editor_api"
                                >
                                    CodeEditor API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#carousel-media-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
