...
export default function Page() {
    ...
    const sections = [
        'carousel-description-api',
        'import',
        'carousel-description-props',
        'system-props',
                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_carousel_description"
                                    >
                                        react-carousel-description
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="carousel-description-api">
                                <Typography variant="h1">
                                    React CarouselDescription API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React
                                    CarouselDescription component from Modj.js.
                                    Learn about how to use the
                                    CarouselDescription component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CarouselDescription"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CarouselDescription } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="carousel-description-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    CarouselDescription component and can be
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_carousel_excerpt_api"
                                >
                                    CarouselExcerpt API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#carousel-description-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
