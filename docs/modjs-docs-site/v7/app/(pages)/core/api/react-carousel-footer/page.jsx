                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_carousel_footer"
                                    >
                                        react-carousel-footer
                                    </Link>
                                </Breadcrumbs>
                            </Container>
                        </Box>
                        ...
                        <Container fluid={false}>
                            <Section id="carousel-footer-api">
                                <Typography variant="h1">
                                    React CarouselFooter API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React CarouselFooter
                                    component from Modj.js. Learn about how to
                                    use the CarouselFooter component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/CarouselFooter"
                                                        target="_blank"
                                ...
                                >
                                    {`import { CarouselFooter } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="carousel-footer-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    CarouselFooter component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_carousel_excerpt_api"
                                >
                                    <LeftArrowIcon />
                                    CarouselExcerpt API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_carousel_item_api"
                                >
                                    CarouselItem API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#carousel-footer-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
