        ...
        <>
            ...
            <UnorderedList indent={false}>
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#carousel-footer-api"
                        active={/#carousel-footer-api$/.test(fragmentId)}
                        data-testid="carousel_footer_api"
                    >
                        CarouselFooter API
                    </Link>
                </List>
                ...
                <List onClick={handleCurrentFragmentId}>
                    <Link
                        variant="transparent"
                        href="#carousel-footer-props"
                        active={/#carousel-footer-props$/.test(fragmentId)}
                        data-testid="carousel_footer_props"
                    >
