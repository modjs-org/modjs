                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_email_field"
                                    >
                                        react-email-field
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="email-field-api">
                                <Typography variant="h1">
                                    React EmailField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React EmailField
                                    component from Modj.js. Learn about how to
                                    use the EmailField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/EmailField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { EmailField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="email-field-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    EmailField Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    EmailField component and can be applied to
                                    this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_dropdown_content_api"
                                >
                                    <LeftArrowIcon />
                                    DropdownContent API
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#email-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
