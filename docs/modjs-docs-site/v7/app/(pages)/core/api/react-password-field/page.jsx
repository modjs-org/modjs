                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_password_field"
                                    >
                        ...
                        <Container fluid={false}>
                            <Section id="password-field-api">
                                <Typography variant="h1">
                                    React PasswordField API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React PasswordField
                                    component from Modj.js. Learn about how to
                                    use the PasswordField component and all the
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/PasswordField"
                                                        target="_blank"
                                ...
                                >
                                    {`import { PasswordField } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section
                                id="password-field-props"
                                pb="normal"
                                mt={16}
                            >
                                ...
                                <Typography variant="body1">
                                    ...
                                    PasswordField component and can be applied
                                    to this component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_ordered_list_api"
                                >
                                    <LeftArrowIcon />
                                    OrderedList API
                                </Link>
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_phone_field_api"
                                >
                                    PhoneField API
                                    <RightArrowIcon />
                                </Link>
                    ...
                    <TableOfContentsWrapper
                        defaultFragmentId="#password-field-api"
                        sections={sections}
                    >
                        <TableOfContents />
                    </TableOfContentsWrapper>
