                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_pill"
                                    >
                                        react-pill
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="pill-api">
                                ...
                                <Typography variant="body1">
                                    API reference for the React Pill component
                                    from Modj.js. Learn about how to use the
                                    Pill component and all the valid props that
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Pill"
                                                        target="_blank"
                                                        data-tesid="import_github"
                                                    >
                                                        <GithubIcon />
                                                    </Link>
                                                }
                                ...
                                >
                                    {`import { Pill } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="pill-props" pb="normal" mt={16}>
                                <Typography variant="h2">Pill Props</Typography>
                                <Typography variant="body1">
                                    The following props are specific to the Pill
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_phone_field_api"
                                >
                                    <LeftArrowIcon />
                                    PhoneField API
                                </Link>
