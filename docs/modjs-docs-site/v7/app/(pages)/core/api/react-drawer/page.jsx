                ...
                <Box display="flex">
                    ...
                    >
                            ...
                            <Container>
                                <Breadcrumbs>
                                    ...
                                    <Link
                                        ...
                                        active={true}
                                        width="auto"
                                        data-testid="breadcrumbs_react_drawer"
                                    >
                                        react-drawer
                                    </Link>
                                </Breadcrumbs>
                        ...
                        <Container fluid={false}>
                            <Section id="drawer-api">
                                <Typography variant="h1">
                                    React Drawer API
                                </Typography>

                                <Typography variant="body1">
                                    API reference for the React Drawer component
                                    from Modj.js. Learn about how to use the
                                    Drawer component and all the valid props
                            ...
                            <Section id="import">
                                        ...
                                        <>
                                            <Tooltip
                                                ...
                                                el={
                                                    <Link
                                                        variant="icon"
                                                        href="https://github.com/modjs-org/modjs/tree/main/packages/core/src/components/Drawer"
                                                        target="_blank"
                                ...
                                >
                                    {`import { Drawer } from '@modjs/core'`}
                                </CodeEditor>
                            </Section>

                            <Section id="drawer-props" pb="normal" mt={16}>
                                <Typography variant="h2">
                                    Drawer Props
                                </Typography>
                                <Typography variant="body1">
                                    The following props are specific to the
                                    Drawer component and can be applied to this
                                    component.
                                </Typography>
                            ...
                            >
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="prev_create_password_field_api"
                                >
                                    <LeftArrowIcon />
                                ...
                                <Link
                                    ...
                                    display="flex"
                                    alignItems="center"
                                    data-testid="next_drawer_content_api"
                                >
                                    DrawerContent API
                                    <RightArrowIcon />
                                </Link>
