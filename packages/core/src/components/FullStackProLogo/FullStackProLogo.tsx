...
const ModButton = styled.button.withConfig({
    ...
    ${props =>
        ...
        background: #ffffff;
// background: linear-gradient(90deg, rgba(90,107,49,1) 0%, rgba(255,255,255,1) 0%, rgba(31,142,255,1) 100%);

        // background: linear-gradient(90deg, rgba(90,107,49,10) 0%, rgba(18,17,17,17) 100%); //green bg

        // clip-path: polygon(8px 0%,100% 0%,100% calc(100% - 14px),calc(100% - 17px) 100%,0% 100%,0% 8px,8px 0%,9.9px 0px,20px 8px,20px calc(100% - 20px),calc(100% - 8px) calc(100% - 20px),calc(100% - 20px) calc(100% - 8px),calc(100% - 20px) 20px,7px 20px);


        clip-path: polygon(8px 0%,100% 0%,100% calc(100% - 8px),calc(100% - 8px) 100%,0% 100%,0% 8px,8px 0%,9.9px 0px,20px 8px,20px calc(100% - 20px),calc(100% - 8px) calc(100% - 20px),calc(100% - 20px) calc(100% - 8px),calc(100% - 20px) 20px,7px 20px);
...
export default withSystemProps(forwardRef(FullStackProLogo))
