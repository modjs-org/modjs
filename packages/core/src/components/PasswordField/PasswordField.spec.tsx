...
describe('<PasswordField>', () => {
    context('Render', () => {
        ...
        it('should render PasswordField with custom props', () => {
            ...
            cy.get('[data-test="password-field-wrapper"]')
                ...
                .then($PasswordFieldWrapper => {
                    const beforeEl = window.getComputedStyle(
                        $PasswordFieldWrapper[0],
                        '::before',
                    )
    ...
    context('Props', () => {
        it('should include only valid props in the DOM element and not include any custom attributes from modjs', () => {
            ...
            cy.get('[data-test="password-field"]').should(
                'have.attr',
                'minLength',
            )
            cy.get('[data-test="password-field"]').should(
            ...
            cy.get('[data-test="password-field"]').should('have.attr', 'type')
            cy.get('[data-test="password-field"]').should('have.attr', 'name')
            cy.get('[data-test="password-field"]').should('have.attr', 'id')
            cy.get('[data-test="password-field"]').should('have.attr', 'value')
            cy.get('[data-test="password-field"]').should(
                'not.have.attr',
                'active',
            )
            ...
            cy.get('[data-test="password-field-wrapper"]').should(
                'not.have.attr',
                'active',
            )
            cy.get('[data-test="password-field-wrapper"]').should(
    ...
    context('Behavior and Interactions', () => {
        it('should not show error if the password is valid', () => {
            cy.mount(
                <ModThemeProvider theme={ModLightTheme}>
                    <Layout p={16}>
                        <PasswordField minLength="2" />
                    </Layout>
                </ModThemeProvider>,
            )
            cy.get('[data-test="password-field"]').type('Testing1234!')
            cy.get('[data-testid="password-field-error"]').should('not.exist')
        })
        it('should show error if the password is not valid', () => {
            cy.mount(
                <ModThemeProvider theme={ModLightTheme}>
                    <Layout p={16}>
                        <PasswordField />
            ...
            cy.get('[data-test="password-field"]').type('Testing')
            cy.get('[data-testid="password-field-error"]').should('exist')
        })
        ...
        it('should not show error if PasswordField is not on focus', () => {
            ...
            cy.get('[data-test="password-field"]').focus().blur()
            cy.get('[data-testid="password-field-error"]').should('not.exist')
        })
        ...
        it('should display light border when the field is not on focus', () => {
            ...
            cy.get('[data-test="password-field-wrapper"]').and(
                'have.css',
                'border',
                '1px solid rgb(194, 194, 194)',
            )
        ...
        it('should display red border when the field is on focus and invalid', () => {
            cy.mount(
                <ModThemeProvider theme={ModLightTheme}>
                    <Layout p={16}>
                        <PasswordField minLength={5} />
                    </Layout>
                </ModThemeProvider>,
            )
            cy.get('[data-test="password-field"]').focus().type('Testing')
            cy.get('[data-test="password-field-wrapper"]').and(
                'have.css',
                'border',
                '1px solid rgb(202, 60, 31)',
        ...
        it('should display green border when the field is on focus and valid', () => {
            ...
            cy.get('[data-test="password-field"]').focus().type('Testing1234!')
            cy.get('[data-test="password-field-wrapper"]').and(
                'have.css',
                'border',
