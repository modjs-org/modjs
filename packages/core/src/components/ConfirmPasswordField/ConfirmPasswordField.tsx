...
const ModConirmPasswordField = styled.input<TextFieldProps>`
    ...
    return (
        <>
            <ModConfirmPasswordFieldWrapper
                ...
                data-test="confirm-password-field-wrapper"
            >
                <PasswordIcon
...
export default withSystemProps(forwardRef(ConfirmPasswordField))
